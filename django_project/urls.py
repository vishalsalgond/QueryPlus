...
urlpatterns = [
    ...
    path('question/<int:pk>/question_upvote', main_views.UpvoteQuestion, name='question-upvote'),
    path('question/<int:pk>/question_downvote', main_views.DownvoteQuestion, name='question-downvote'),
    path('question/<int:pk>/answer_upvote', main_views.UpvoteAnswer, name='answer-upvote'),
    path('question/<int:pk>/answer_downvote', main_views.DownvoteAnswer, name='answer-downvote'),
